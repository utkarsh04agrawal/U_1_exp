...
ROOT_DIRECTORY = 'Weak measurements/Purification/'
...
#----------------------------------------------------------------------------------------------------#
    def set_circuit_variables():
        ...
        root_dir = ROOT_DIRECTORY + 'data/circ_data/'
...
#----------------------------------------------------------------------------------------------------#
    def get_filedir():
        ...
        filedir = ROOT_DIRECTORY + 'data/qiskit_data/measurement_data_all_qubits'+ scrambling_label + noisy_label + depth_label+'/'
